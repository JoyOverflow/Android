package pxgd.hyena.com.tagimageview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TagImageView mSimpleTagImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSimpleTagImageView = (TagImageView) findViewById(R.id.stiv);
    ...
    private void setUpTextStyleSpinner() {
        ...
        styles.put("NORMAL", TagImageView.TEXT_STYLE_NORMAL);
        styles.put("BOLD", TagImageView.TEXT_STYLE_BOLD);
        styles.put("ITALIC", TagImageView.TEXT_STYLE_ITALIC);
        styles.put("BOLD_ITALIC", TagImageView.TEXT_STYLE_BOLD_ITALIC);
    ...
    private void setUpTagOrientation() {
        ...
        orientations.put("LEFT_TOP", TagImageView.LEFT_TOP);
        orientations.put("RIGHT_TOP", TagImageView.RIGHT_TOP);
        orientations.put("LEFT_BOTTOM", TagImageView.LEFT_BOTTOM);
        orientations.put("RIGHT_BOTTOM", TagImageView.RIGHT_BOTTOM);
