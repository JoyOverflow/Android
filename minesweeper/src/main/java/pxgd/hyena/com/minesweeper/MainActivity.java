package pxgd.hyena.com.minesweeper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置文本视的显示字体
        Typeface lcdFont = Typeface.createFromAsset(
                getAssets(), "fonts/lcd2mono.ttf");
    ...
    private void showMineField()
    {
        ...
        for (int row = 1; row < numberOfRowsInMineField + 1; row++)
        {
            ...
            tableRow.setLayoutParams(new LinearLayout.LayoutParams((blockDimension + 2 * blockPadding) * numberOfColumnsInMineField, blockDimension + 2 * blockPadding));
